...
QT_MOC_LITERAL(3, 23, 15), // "latitudeChanged"
QT_MOC_LITERAL(4, 39, 16), // "longitudeChanged"
QT_MOC_LITERAL(5, 56, 12), // "colorChanged"
QT_MOC_LITERAL(6, 69, 9), // "getObject"
QT_MOC_LITERAL(7, 79, 4), // "name"
QT_MOC_LITERAL(8, 84, 8), // "latitude"
QT_MOC_LITERAL(9, 93, 9), // "longitude"
QT_MOC_LITERAL(10, 103, 5) // "color"

    },
    "DataModel\0nameChanged\0\0latitudeChanged\0"
    "longitudeChanged\0colorChanged\0getObject\0"
    "name\0latitude\0longitude\0color"
};
...
void DataModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { QObject* _r = _t->getObject();
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataModel::nameChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DataModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataModel::latitudeChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (DataModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataModel::longitudeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (DataModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataModel::colorChanged)) {
                *result = 3;
                return;
            }
        }
        ...
        case 1: *reinterpret_cast< qreal*>(_v) = _t->latitude(); break;
        case 2: *reinterpret_cast< qreal*>(_v) = _t->longitude(); break;
        ...
        case 1: _t->setLatitude(*reinterpret_cast< qreal*>(_v)); break;
        case 2: _t->setLongitude(*reinterpret_cast< qreal*>(_v)); break;
...
// SIGNAL 0
void DataModel::nameChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DataModel::latitudeChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void DataModel::longitudeChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void DataModel::colorChanged()
{
