    ...
    , _enabled(true)
{
    ...
    _labeloff->move(pos_off, 5);
    _labeloff->setStyleSheet("background-color: rgba(0,0,0,0%); color: rgb(120, 120, 120); font-weight: bold; text-align:right;");
    _labeloff->setAlignment(Qt::AlignRight | Qt::AlignVCenter);
    _labeloff->setLayoutDirection(Qt::RightToLeft);
    _labelon->move(pos_on, 5);
    _labelon->setStyleSheet("background-color: rgba(0,0,0,0%); color: rgb(255, 255, 255); font-weight: bold; text-align:left;");
    _labelon->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
    _labelon->setLayoutDirection(Qt::LeftToRight);
    setFixedSize(size);
    ...
    , _pencolor(QColor(170, 170, 170))
{
    ...
    _lg.setColorAt(0, QColor(color));
    _lg.setColorAt(0.25, QColor(color));
    _lg.setColorAt(0.95, QColor(color));
